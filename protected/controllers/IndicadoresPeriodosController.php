...
class IndicadoresPeriodosController extends Controller
{
	...
	{
		$model = IndicadoresPeriodos::model()->findAll("id_empresa = ".Yii::app()->user->getState("id_empresa"));
	...
	{
		$usuarios = Usuarios::model()->findAll('id_empresa ='.Yii::app()->user->getState("id_empresa"));
