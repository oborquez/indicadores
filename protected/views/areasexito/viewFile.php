...
$this->breadcrumbs=array(
	'Áres de éxito'=>array("/areasexito"),
	$model->valor->area->nombre=>array("/areasexito/area/".$model->valor->area->id),
	"Archivo"
...
<div class="row">
	<div class="col-sm-12">
		...
		<?if(isOfficeFile( $model->archivo )):?>	
			<!-- Microsoft viewer -->
			<iframe src="https://view.officeapps.live.com/op/view.aspx?src=http://cdt.empresainteligente.com<?echo Yii::app()->baseUrl?>/resources/areasexito/<?echo $model->archivo?>&embedded=true" style="width:100%; height:500px;" frameborder="0"></iframe>	
		<?else:?>
			<!-- Google  -->
			...
			<iframe src="<?echo Yii::app()->baseUrl?>/resources/areasexito/<?echo $model->archivo?>" style="width:100%; height:500px;" frameborder="0"></iframe>
		<?endif?>
		</div>
	</div>
</div>		
