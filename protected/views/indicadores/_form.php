		...
		<?php $form=$this->beginWidget('CActiveForm', array(
			...
			<?php echo $form->errorSummary($model,NULL,NULL,array('class'=>'note note-danger')); ?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<?php echo $form->dropDownList($model,'id_usuario',CHtml::listData(Usuarios::model()->findAll( "id_empresa =".Yii::app()->user->getState("id_empresa") ),"id","nombre"),array('style'=>'width:200px','class'=>'form-control')); ?>
